    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] gap-3">
        ...
        <span className="text-xs font-bold text-slate-500 animate-pulse">
          Loading Store Setup parameters...
        </span>
      </div>
    );
  }
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base font-black text-slate-900 dark:text-foreground">
                    Store Identity & Overview
                  </h2>
                  <p className="text-xs text-slate-500">
                    Basic information visible across customer invoices, emails, and header titles.
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-[10px] text-slate-400">
                  Displayed in storefront branding, order emails, and receipts.
                </p>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-[10px] text-slate-400">
                  Your default storefront address URL on the platform.
                </p>
              </div>
              ...
              <div className="md:col-span-2 space-y-1.5">
                ...
                />
                <p className="text-[10px] text-slate-400">
                  Used for search engine meta descriptions and storefront footer section.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-card border border-slate-200/80 dark:border-border shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-border pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base font-black text-slate-900 dark:text-foreground">
                    Store Logo & Favicon Assets
                  </h2>
                  <p className="text-xs text-slate-500">
                    Upload or set image URLs for high-resolution store logo and browser tab favicon.
                  </p>
                </div>
              </div>
              <span className="px-2.5 py-1 rounded-full bg-slate-100 dark:bg-accent text-slate-600 text-[10px] font-bold uppercase tracking-wider">
              ...
              <div className="flex items-center justify-between border-b border-slate-100 dark:border-border pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Support contact info displayed to buyers on checkout pages & order
                      confirmations.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between border-b border-slate-100 dark:border-border pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Physical address used for tax calculations, shipping return slips, and legal
                      disclosures.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between border-b border-slate-100 dark:border-border pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Connect social channels to render footer icons and increase social engagement.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    icon: LinkIcon,
                    color: 'text-blue-700',
                    placeholder: 'https://linkedin.com/company/mybrand',
                  },
                  {
                    field: 'socialYoutube',
          ...
          <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-card border border-slate-200/80 dark:border-border shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-border pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Connect custom domains with automatic free SSL certificate generation and DNS
                    mapping.
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="p-5 rounded-2xl bg-slate-50/60 dark:bg-card border border-slate-200/80 space-y-3">
                ...
                <p className="text-[10px] text-slate-400">
                  Always active as your system fallback URL.
                </p>
              </div>
              ...
              <div className="p-5 rounded-2xl bg-slate-50/60 dark:bg-card border border-slate-200/80 space-y-3">
                ...
                />
                <p className="text-[10px] text-slate-400">
                  Enter your purchased domain name without http/https prefix.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-teal-50/40 dark:bg-teal-950/20 border border-teal-200/60 space-y-3">
              ...
              <p className="text-xs text-teal-800 dark:text-teal-400">
                To map <strong>{formData.customDomain || 'your custom domain'}</strong>, point your
                domain registrar's CNAME record to the target below:
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-1">
                <div className="p-3 rounded-xl bg-white dark:bg-card border border-teal-100 dark:border-border text-center">
                  ...
                  <span className="text-xs font-mono font-black text-slate-800 dark:text-foreground">
                    CNAME
                  </span>
                </div>
                <div className="p-3 rounded-xl bg-white dark:bg-card border border-teal-100 dark:border-border text-center">
                ...
                <div className="p-3 rounded-xl bg-white dark:bg-card border border-teal-100 dark:border-border text-center">
                  ...
                  <span className="text-xs font-mono font-black text-teal-600 dark:text-teal-400 truncate">
                    cname.omnistore.com
                  </span>
                </div>
              </div>
          ...
          <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-card border border-slate-200/80 dark:border-border shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-border pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Configure transactional currency, default storefront locale language, and store
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-[10px] text-slate-400">
                  Default currency displayed on product prices and checkout receipts.
                </p>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-[10px] text-slate-400">
                  Default storefront text, regional WhatsApp catalog, and system notification
                  language.
                </p>
              </div>
