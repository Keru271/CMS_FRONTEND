...
export const PageManager: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<
    'ALL' | 'SYSTEM' | 'BRAND' | 'POLICY' | 'CUSTOM' | 'DRAFT'
  >('ALL');
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-16">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">
                    Configure page content, URL handle, type, and search engine metadata.
                  </p>
                </div>
              </div>
              <button
                ...
                <div className="space-y-3">
                  ...
                  <div className="p-3.5 rounded-xl bg-white border border-indigo-100 space-y-1">
                    ...
                    <span className="text-[11px] font-mono text-emerald-700 block">
                      {STOREFRONT_URL}
                      {formData.slug.startsWith('/') ? formData.slug : '/' + formData.slug}
                    </span>
      ...
      {previewPage &&
        (() => {
          ...
          const renderMockContent = (content: string) => {
            if (!content)
              return <p className="text-slate-400 italic">No content available for this page.</p>;
                      ...
                      {parsed.map((block: any, idx: number) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {block.data?.subtitle && (
                              <p className="text-xs text-slate-600">{block.data.subtitle}</p>
                            )}
                            {block.data?.description && (
                              <p className="text-xs text-slate-600">{block.data.description}</p>
                            )}
                            {block.data?.html && (
                              <div
              ...
              <div className="h-14 px-4 bg-slate-900 text-white flex items-center justify-between gap-4 border-b border-slate-800 shrink-0">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-indigo-300 font-mono truncate max-w-xs">
                      {pageRoute}
                    </p>
                  </div>
                </div>
                        ...
                        <div className="max-w-6xl mx-auto flex items-center justify-between gap-4">
                          <div className="flex items-center gap-2.5">
                            ...
                            <div className="flex flex-col leading-none">
                              ...
                              <span className="text-[8px] tracking-[0.2em] font-bold text-indigo-400 uppercase mt-0.5">
                                FURNITURE & LIVING
                              </span>
                            </div>
                          </div>
                          ...
                          <div className="hidden md:flex flex-1 max-w-md mx-4">
                            <div className="flex items-center bg-white rounded-full p-1 w-full border border-slate-300">
                              ...
                              <button
                                type="button"
                                className="bg-amber-400 text-slate-950 px-3 py-1 rounded-full font-bold text-xs"
                              >
                                Search
                              </button>
                            </div>
                      ...
                      <nav className="w-full bg-[#2a2f34] text-white border-b border-[#373e45] hidden sm:block shrink-0">
                        <div className="max-w-6xl mx-auto px-4 flex items-center justify-between text-xs font-semibold">
                          <div className="flex items-center">
                            ...
                            <span className="px-3 py-2.5 text-slate-200 hover:text-amber-400 transition cursor-pointer">
                              Home
                            </span>
                            <span className="px-3 py-2.5 text-slate-200 hover:text-amber-400 transition cursor-pointer">
                              Living Room
                      ...
                      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-8 py-10 sm:py-14 w-full">
                        ...
                        <nav className="flex items-center gap-2 text-xs text-slate-500 mb-6 font-medium">
                          ...
                          <span className="text-slate-600">
                            {previewPage.pageType === 'POLICY' ? 'Policies' : 'Pages'}
                          </span>
                          <span>/</span>
                        ...
                        <div className="mt-10 p-6 sm:p-8 rounded-3xl border border-slate-200 bg-indigo-50/50 flex flex-col sm:flex-row items-center justify-between gap-4">
                          <div className="space-y-1 text-center sm:text-left">
                            ...
                            <p className="text-xs text-slate-600">
                              Our customer support concierge is always available to help.
                            </p>
                          </div>
                          <div className="flex items-center gap-2.5">
                            <button
                              type="button"
                              className="px-4 py-2 text-white text-xs font-bold rounded-xl bg-indigo-600 hover:bg-indigo-500 transition shadow"
                            >
                              Contact Support
                            </button>
                            <button
                              type="button"
                              className="px-4 py-2 text-xs font-bold rounded-xl border border-slate-300 bg-white text-slate-700 hover:bg-slate-50 transition"
                            >
                              Continue Shopping
                            </button>
                          </div>
                      ...
                      <footer className="w-full bg-[#181a1c] text-[#9ca3af] text-xs pt-12 pb-6 border-t border-[#26292d] mt-12 shrink-0">
                        <div className="max-w-6xl mx-auto px-4 sm:px-6">
                          ...
                          <div className="bg-[#23272a] rounded-2xl p-6 sm:p-8 mb-10 border border-[#2e3338] grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
                            <div className="md:col-span-7 space-y-1">
                              ...
                              <p className="text-slate-400 text-xs">
                                Subscribe to get special offers, design tips, and member drops.
                              </p>
                            </div>
                            <div className="md:col-span-5 flex gap-2">
                              ...
                              <button
                                type="button"
                                className="px-4 py-2 bg-amber-400 text-slate-950 font-bold text-xs rounded-xl shrink-0"
                              >
                                Subscribe
                              </button>
                            </div>
                          ...
                          <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] text-slate-500">
                            <p>
                              © {new Date().getFullYear()} OmniStore Retail. All rights reserved.
                            </p>
                            <div className="flex items-center gap-2">
                              <span className="px-2 py-0.5 bg-[#23272a] rounded text-[10px] font-bold text-white border border-[#373e45]">
                                VISA
                              </span>
                              <span className="px-2 py-0.5 bg-[#23272a] rounded text-[10px] font-bold text-white border border-[#373e45]">
                                MASTERCARD
      ...
      {isPageBuilderOpen && (
        <PageBuilderStudio
          key={
            builderEditingPage?.id ? `edit-page-${builderEditingPage.id}` : `new-page-${Date.now()}`
          }
