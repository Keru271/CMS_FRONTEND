...
import { X, Copy, Check, Code2, ExternalLink, Share2, Globe, Sparkles } from 'lucide-react';
      ...
      <div className="relative w-full max-w-2xl bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden">
        ...
        <div className="p-6 space-y-4">
          {activeTab === 'link' && (
            <div className="space-y-4">
              <p className="text-sm text-slate-600 dark:text-slate-400">
                Share this direct URL with your customers, in newsletter campaigns, or link to it
                from your navigation header.
              </p>
          ...
          {activeTab === 'iframe' && (
            <div className="space-y-4">
              <p className="text-sm text-slate-600 dark:text-slate-400">
                Paste this HTML snippet into any page, blog post, or external website to embed this
                responsive form.
              </p>
